...
document.addEventListener('keydown', function(event) {
    ...
    if(event.key == "1" || event.key == "2" || event.key == "3" || event.key == "4" || event.key == "5" || event.key == "6" || event.key == "7" || event.key == "8") {
        ...
        // Manche 1 Question 2 
            ...
            video.src = '../assets/video/Manche_1_Question_2_Zouk_Machine_Maldon.mp4';
        }
        // Manche 1 Question 3
        else if (event.key === "3") {
            video.src = '../assets/video/Manche_1_Question_3_Joe_Cocker_You_Can_Leave_Your_Hat_On.mp4';
        } 
        // Manche 2 Question 1 
        else if (event.key === "4") {
            video.src = '../assets/video/Manche_2_Question_1_Coup_De_Gueule.mp4';
        }
        // Manche 2 Question 2 
        if (event.key === "5") {
            video.src = '../assets/video/Manche_2_Question_2_Movie_Company_Intros.mp4';
        }
        // Manche 2 Question 3 
        else if (event.key === "6") {
            video.src = '../assets/video/Manche_2_Question_3_ Joe_Cocker_You Can_Leave_Your_Hat_On.mp4';
        }
